...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ma.beit.wfahm.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ma.beit.wfahm.repository.UserRepository.USERS_BY_EMAIL_CACHE);
