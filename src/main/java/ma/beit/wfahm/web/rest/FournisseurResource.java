...
import ma.beit.wfahm.domain.Fournisseur;
import ma.beit.wfahm.repository.FournisseurRepository;
...
/**
 * REST controller for managing {@link ma.beit.wfahm.domain.Fournisseur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
